...
from ignite.metrics import Metric, Accuracy, Loss
        ...
        if 'distributed_config' in self.__dict__:
            ...
            def training(local_rank):
                ...
                def run_validation(engine):
                    ...
                    print(f"\nEpoch {epoch} - metrics:\n {metrics_output}")
                train_engine.add_event_handler(Events.EPOCH_COMPLETED(every=1) | Events.COMPLETED, run_validation)
