...
class CustomModel(Model):
    ...
    def train_step(self, engine, batch):
        ...
        print(
            ...
            % (engine.state.epoch, opt.n_epochs, d_loss.item(), g_loss.item())
        )
        return {"d_loss": d_loss.item(), "g_loss": g_loss.item()}

model = CustomModel()
config = {"batch_size": opt.batch_size, "num_workers": 4, "shuffle": True}
model.fit(train_dataset=mnist_dataset, train_dataloader_config=config, num_epochs=opt.n_epochs)
